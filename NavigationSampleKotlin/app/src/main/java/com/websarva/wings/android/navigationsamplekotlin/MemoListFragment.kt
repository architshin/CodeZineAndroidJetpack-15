package com.websarva.wings.android.navigationsamplekotlin
...
import com.websarva.wings.android.navigationsamplekotlin.databinding.FragmentMemoListBinding
import com.websarva.wings.android.navigationsamplekotlin.databinding.MemoListItemBinding
import com.websarva.wings.android.navigationsamplekotlin.ui.MemoListViewModel
...
class MemoListFragment : Fragment() {
	...
	private inner class OnListItemClickListener : View.OnClickListener {
		override fun onClick(view: View) {
			...
			arguments.putLong("memoId", memoId)
