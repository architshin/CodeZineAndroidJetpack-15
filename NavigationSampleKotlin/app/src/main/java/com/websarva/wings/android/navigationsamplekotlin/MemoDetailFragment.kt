...
import com.websarva.wings.android.navigationsamplekotlin.databinding.FragmentMemoDetailBinding
import com.websarva.wings.android.navigationsamplekotlin.ui.MemoDetailViewModel
...
class MemoDetailFragment : Fragment() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		_memoDetailViewModel.memoId = arguments?.getLong("memoId") ?: 0
	}
